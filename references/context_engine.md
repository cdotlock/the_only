...
6. **Regenerate markdown**: `python3 scripts/memory_io.py --action project`
...
Generated by `python3 scripts/memory_io.py --action project`. Never edit these files directly.
...
| Markdown regen only | `python3 scripts/memory_io.py --action project` |
